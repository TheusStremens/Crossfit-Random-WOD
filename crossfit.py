...
abs_exercises["lateral"].append("Dumbell Side Bend")
...
other_exercises["shoulder"].append("Dumbell Shoulder Press")
...
other_exercises["shoulder"].append("Overhead Dumbell Reverse Lunge")

other_exercises["biceps"].append("Standing Dumbell Curl Alternate")
other_exercises["biceps"].append("Standing Dumbell Curl")
other_exercises["biceps"].append("Hammer Curl")
other_exercises["biceps"].append("Dumbell Concentration Curl")
...
other_exercises["quadriceps"].append("Walking Lunge Dumbell")
